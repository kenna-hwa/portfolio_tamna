...
$sql = "select * from tnotice where idx=1;";
    ...
    <main id="main" class="main">
        ...
        <div class="tamna_notice_table_box">
            <table class="tamna_notice_table">
                    ...
                    <?php
                    $sqlnext = "select * from tnotice where idx=2;";
                    ...
                    <tr class="tamna_notice_tableNext">
                        ...
                        <td class="tamna_notice_next_title" colspan="2"><a href="notice_board2.php">
                    ...
                    <tr class="tamna_notice_tablePrev">
                        ...
                        <td class="tamna_notice_prev_title" colspan="2">이전글이 없습니다.</td>
                    </tr>
            </table>
