...
$sql = "select * from tnotice where idx=3;";
    ...
    <main id="main" class="main">
        ...
        <div class="tamna_notice_table_box">
            <table class="tamna_notice_table">
                    ...
                    <?php
                    $sqlnext = "select * from tnotice where idx=4;";
                    ...
                    <tr class="tamna_notice_tableNext">
                        ...
                        <td class="tamna_notice_next_title" colspan="2"><a href="notice_board4.php">
                    ...
                    <tr class="tamna_notice_tablePrev">
                        ...
                        <td class="tamna_notice_prev_title" colspan="2"><a href="notice_board2.php"><?php echo $arrayprev["tnt_category"]." ".$arrayprev["tnt_title"]; ?></a></td>
                    </tr>
            </table>
