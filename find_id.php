...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@100;300;400;500;700;900&display=swap"
        rel="stylesheet">
    <link type="text/css" rel="stylesheet" href="css/find_id.css">
    ...
    <main id="main" class="main">
        ...
        <div class="tamna_find">
            ...
            <div class="tamna_find_txt">
                회원가입 시 등록한 이름과 휴대폰번호를 입력해주세요.
            </div>
        <!-- tamna find end -->
        </div>
            <!-- tamna input form -->
        <div class="tamna_input_form">
            <form name="find_id" action="return_id.php" method="post" onsubmit="return findIdCheck()">
                <fieldset>
                <legend class="blind"> 아이디찾기 </legend>
                    <!-- username -->
                    ...
                    <button type="submit" value="next" class="tamna_find_next_btn">아이디 찾기</button>
                    </div>
